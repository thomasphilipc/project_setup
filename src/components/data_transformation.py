...
class DataTransformation():
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            logging.info(f"the selected target columns name is {self.target_column_name}")
            numeric_features = [feature for feature in df.columns if df[feature].dtype != 'O']
            categorical_features = [feature for feature in df.columns if df[feature].dtype == 'O']
            if self.target_column_name in numeric_features: numeric_features.remove(self.target_column_name)
            if self.target_column_name in categorical_features: categorical_features.remove(self.target_column_name)
            logging.info("code")
